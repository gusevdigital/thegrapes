	...
	<div class="row">
		<div class="col-12">
			<?php foreach ( $notices as $notice ) : ?>
				...
				<div class="d-flex flex-column flex-lg-row justify-content-between align-items-center woocommerce-info notify mb-6 p-3"<?php echo wc_get_notice_data_attr( $notice ); ?> role="alert">
						<?php
