...
$currentPtCount = get_query_var( 'current_pt_count' );

$pt_active = !$currentPtCount ? ' active' : '';

?>

<figure <?php wc_product_class( 'carousel-item pt-pr col-lg-4' . $pt_active, $product ); ?>>
