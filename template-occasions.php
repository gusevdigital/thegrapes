...
$occasions_title = get_theme_mod( 'set_occasions_title', '' );
$occasions_desc = get_theme_mod( 'set_occasions_desc', '' );
$occasions_img = get_theme_mod( 'set_occasions_img' );
		...
		<div class="row d-flex align-items-center">
			<div class="col-lg-6 col-xl-5 col-12 intro-text mb-1">
				<div class="intro-text wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">
					<h1><?php echo $occasions_title != ''? esc_html($occasions_title) : get_the_title(); ?></h1>
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><?php echo $occasions_title != ''? esc_html($occasions_title) : get_the_title(); ?></li>
						</ol>
					</nav>
					<div class="subheader mb-5">
						<p class="lead">
							<?php echo wpautop( esc_html($occasions_desc), false ); ?>
						</p>
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-xl-7 col-12 home-intro-wrap mb-5">
        <?php if( isset($occasions_img) && $occasions_img ): ?>
					<div class="intro-bg-img">
						<?php echo wp_get_attachment_image( $occasions_img, 'full', false, array( 'class' => ' wow fadeInUp nolazyload', 'data-wow-duration' => '1s', 'data-wow-delay' => '.4s' ) ); ?>
					</div>
				<?php endif; ?>
			</div>
		</div>
			...
			<div class="row pt-group mb-6">
				<?php if ( $tax_img = get_term_meta($term->term_id, 'term_image', true) ) : ?>
					<div class="col-lg-4 mb-6">
						<img src="<?php echo $tax_img; ?>" alt="<?php echo $term->name; ?>" class="pt-group-img"/>
					</div>
        <?php endif; ?>
